...
const tooltipTexts = {
  en: {
    ...
    skill_seo: 'Search engine optimisation for discoverable, well-structured websites.',
...
<span class="token-punct">}</span></pre>
  ...
  cs: {
    ...
    skill_design_systems: 'Buduji konzistentní a znovupoužitelné UI systémy.',
    ...
    skill_prototyping: 'Prototypy používám k rychlému ověření nápadů a navržených řešení.',
    skill_user_flows: 'Tvořím user flows pro ověření kroků a zmapování komplexních rozhraní.',
    skill_information_architecture: 'Strukturuji obsah tak, aby se v něm uživatel snadno orientoval.',
    skill_usability_testing: 'Testuji návrhy s reálnými uživateli a hledám místa ke zlepšení.',
    ...
    skill_html_css: 'Díky znalosti HTML, CSS a technickému přesahu navrhuji s ohledem na reálnou implementaci.',
    ...
    skill_wireframing: 'Wireframy používám k rychlému ověření struktury a layoutu.',
    ...
    skill_documentation: 'Tvořím dokumentaci, která usnadňuje práci s komponentami a design systémem.',
