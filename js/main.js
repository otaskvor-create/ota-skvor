...
const translations = {
  ...
  cs: {
    ...
    contact_sub: 'Dostupný pro projekty, konzultace a rozhovory.',
...
const tooltipTexts = {
  en: {
    ...
    skill_design_systems: 'Building consistent reusable UI systems for scale.',
    skill_ui_design: 'High-fidelity interface design with attention to detail.',
    ...
    skill_prototyping: 'Rapid prototyping for exploration and stakeholder validation.',
    skill_user_flows: 'Mapping user journeys and task flows for clear experience paths.',
    skill_information_architecture: 'Structuring content and pathways for clear navigation.',
    skill_usability_testing: 'Testing with real users to uncover usability issues.',
    skill_ab_testing: 'Running experiments to learn what works best.',
    skill_figma: 'Crafting responsive UI in Figma with components and variants.',
    ...
    skill_miro: 'Workshop facilitation and collaboration in Miro.',
    skill_notion: 'Documentation and team workflows organised in Notion.',
    skill_design_tokens: 'Design tokens for consistent theming and scale.',
    skill_component_libraries: 'Component libraries for consistent reusable UI and developer handoff.',
    skill_component_apis: 'Designing component APIs with clear props and states.',
    skill_html_css: 'Understanding markup and styles for accurate handoff.',
    skill_accessibility: 'Designing accessible interfaces with contrast, labels and inclusive patterns.',
    skill_wcag_accessibility: 'Accessible layouts and interactions following WCAG.',
    skill_responsive_design: 'Layouts that adapt smoothly across screen sizes.',
    skill_dev_collaboration: 'Close design-dev alignment for consistent delivery.',
    skill_git_basics: 'Version control basics for collaborative work.',
    ...
    skill_ux_design: 'User experience design practices including research and flows.',
    skill_wireframing: 'Low-fidelity wireframes to validate structure and flow.',
    skill_visual_design: 'Visual design: typography, layout, and visual systems.',
    skill_color_theory: 'Color systems, contrast and harmony for usable interfaces.',
    skill_documentation: 'Creating clear documentation for patterns and processes.',
    skill_js_python: 'Basic scripting knowledge in JavaScript and Python.',
    ...
    skill_figjam: 'Collaborative whiteboarding and workshops in FigJam.',
    skill_photoshop: 'Raster editing, compositing and image preparation in Photoshop.',
    edu_typography: 'Study of typefaces, letterforms, and typographic systems for effective communication.',
    edu_color_theory: 'Understanding color relationships, contrast, and harmony in visual design.',
    edu_grid_systems: 'Foundational systems for organizing content and creating visual order.',
    edu_visual_identity: 'Creating cohesive brand systems including logos, palettes and design guidelines.',
    edu_information_design: 'Structuring and presenting information clearly through visual means.',
    edu_digital_design: 'Design principles and techniques for digital media and interactive products.',
    edu_user_research: 'Research methodologies including interviews, surveys, and user testing.',
    edu_interaction_design: 'Designing meaningful interactions and user flows for digital products.',
    edu_design_systems: 'Building scalable systems of reusable components and design standards.',
    edu_accessibility: 'Ensuring digital products are usable by everyone, including people with disabilities.',
    edu_design_thinking: 'Problem-solving methodology focused on user needs and iterative solutions.',
...
<span class="token-punct">}</span></pre>
  ...
  cs: {
    ...
    skill_design_systems: 'Budování konzistentních znovupoužitelných UI systémů.',
    skill_ui_design: 'Detailně propracovaný vizuální design rozhraní.',
    ...
    skill_prototyping: 'Rychlé prototypování pro testování nápadů.',
    skill_user_flows: 'Mapování uživatelských cest a toků pro jasnou zkušenost.',
    skill_information_architecture: 'Řazení obsahu a cesty pro jasnou orientaci.',
    skill_usability_testing: 'Testování s reálnými uživateli pro lepší použitelnost.',
    skill_ab_testing: 'Experimenty, které ukazují, co funguje nejlépe.',
    skill_figma: 'Tvorba responzivního UI ve Figmě s komponentami.',
    ...
    skill_miro: 'Spolupráce a workshopy v Miro.',
    skill_notion: 'Dokumentace a pracovní toky organizované v Notion.',
    skill_design_tokens: 'Design tokeny pro konzistentní téma a škálování.',
    skill_component_libraries: 'Komponentní knihovny pro konzistentní opakovaně použitelné UI a předání vývoji.',
    skill_component_apis: 'Návrh API komponent s jasnými vlastnostmi.',
    skill_html_css: 'Pochopení značkování a stylů pro přesné předání.',
    skill_accessibility: 'Návrh přístupných rozhraní se zaměřením na kontrast, popisky a inkluzivní vzory.',
    skill_wcag_accessibility: 'Přístupné rozhraní podle WCAG principů.',
    skill_responsive_design: 'Rozvržení, která se hladce přizpůsobí obrazovkám.',
    skill_dev_collaboration: 'Těsná spolupráce designu a vývoje.',
    skill_git_basics: 'Základy verzování pro týmovou práci.',
    ...
    skill_ux_design: 'Návrh uživatelské zkušenosti včetně výzkumu a toků.',
    skill_wireframing: 'Nízkofidelitní wireframy pro ověření struktury a toku.',
    skill_visual_design: 'Vizuální design: typografie, rozložení a vizuální systémy.',
    skill_color_theory: 'Barevné systémy, kontrast a harmonie pro použitelná rozhraní.',
    skill_documentation: 'Tvorba srozumitelné dokumentace pro vzory a procesy.',
    skill_js_python: 'Základy skriptování v JavaScriptu a Pythonu.',
    skill_cloude: 'AI asistent (Claude) pro nápady a výzkumné workflow.',
    skill_wordpress: 'Budování a správa webů pomocí WordPressu.',
    skill_trello: 'Organizace projektů, úkolů a plánování sprintů v Trellu.',
    skill_midjourney: 'Kreativní AI nápady a generování vizuálů ve Midjourney.',
    skill_figjam: 'Spolupráce a workshopy ve FigJam.',
    skill_photoshop: 'Úprava rastrových obrázků a kompozice ve Photoshopu.',
    edu_typography: 'Studium písem, tvarů písem a typografických systémů pro efektivní komunikaci.',
    edu_color_theory: 'Porozumění vztahům barev, kontrastu a harmonii v designu.',
    edu_grid_systems: 'Fundamentální systémy pro organizaci obsahu a vytváření vizuálního řádu.',
    edu_visual_identity: 'Vytváření koherentních značkovacích systémů včetně log, palet a designových pokynů.',
    edu_information_design: 'Strukturování a prezentace informací jasně pomocí vizuálních prostředků.',
    edu_digital_design: 'Designové principy a techniky pro digitální média a interaktivní produkty.',
    edu_user_research: 'Výzkumné metodologie včetně rozhovorů, průzkumů a uživatelského testování.',
    edu_interaction_design: 'Návrh smysluplných interakcí a uživatelských cest pro digitální produkty.',
    edu_design_systems: 'Budování škálovatelných systémů opakovaně použitelných komponent a designových norem.',
    edu_accessibility: 'Zajištění, že digitální produkty jsou použitelné pro všechny, včetně lidí se zdravotním postižením.',
    edu_design_thinking: 'Metodologie řešení problémů zaměřená na potřeby uživatelů a iterativní řešení.',
